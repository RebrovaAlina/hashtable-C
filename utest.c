...
int main() {
        ...
        if (err != STERR_NOADD&& err!= STERR_SUCCESS)
        ...
        if (err != STERR_NOELEM&& err!= STERR_SUCCESS)
        ...
        if (err != STERR_DELETED&& err!= STERR_SUCCESS)
        ...
        if (err != STERR_DELETEDALL&& err!= STERR_SUCCESS)
